...
//                .setOrigin(origin)
    ...
    public ProductDTO(Long id, String productName, Category category, String urlImage, Long price, Integer quantity, boolean deleted, Status status) {
        this.id = id;
    ...
    public String toString() {
        return productName + " " + category.getCategory() + " " + price + " " + quantity ;
    }
